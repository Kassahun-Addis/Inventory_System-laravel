...
<h2 style="text-align: center; padding:10px;">Employee List</h2>
   ...
   <div class="row mb-3" style="display: flex; justify-content: space-between; align-items: center;">
    ...
    <div class="col-12 col-md-6 d-flex justify-content-between mb-2 mb-md-0">
        <!-- Per Page Selection -->
        <form action="{{ route('employee.index') }}" method="GET" class="form-inline" style="flex: 1;">
        ...
        <!-- Add New Button -->
        <a href="{{ route('employee.create') }}" class="btn btn-primary ml-2">Add New</a>
    </div>
            ...
            <div class="form-group w-100" style="display: flex; align-items: center;">
                ...
                <div class="d-block d-md-none dropdown ml-1">
                    ...
                    <div class="dropdown-menu" aria-labelledby="exportDropdown">
                        ...
                        <a class="dropdown-item" href="{{ route('employee.export') }}">Excel</a>
                    </div>
                </div>
                ...
                <div class="d-none d-md-block ml-1">
                    ...
                    <button type="button" class="btn btn-primary ml-1" onclick="window.location.href='{{ route('employee.export') }}'">Excel</button>
                </div>
            </div>
        </form>
    </div>
